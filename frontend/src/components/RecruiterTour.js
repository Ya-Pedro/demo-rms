...
const STEPS = [
  ...
  step('edit-btn',          '✏️ Редактирование',        'Нажмите, чтобы изменить статус вакансии, обновить зарплату, даты или другие детали.'),
  step('history-btn',       '📜 История изменений',     'Нажмите, чтобы посмотреть историю всех изменений по вакансии — кто, когда и что именно изменил.'),
  step('delegate-btn',      '🤝 Делегирование',         'Нажмите для делегирования (передачи) вакансии другому рекрутеру на время или на постоянной основе.'),
